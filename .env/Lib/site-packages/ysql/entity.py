...
# ====================================================================================================================
# 模块常量
CONSTRAINT_TYPE_IGNORE = "ignore"
CONSTRAINT_TYPE_PRIMARY_KEY = "primary_key"
CONSTRAINT_TYPE_AUTO_PRIMARY_KEY = "auto_primary_key"
CONSTRAINT_TYPE_NOT_NULL = "not_null"
CONSTRAINT_TYPE_UNIQUE = "unique"
CONSTRAINT_TYPE_FOREIGN_KEY = "foreign_key"
CONSTRAINT_TYPE_DEFAULT = "default"
CONSTRAINT_TYPE_CHECK = "check"
CONSTRAINT_TYPE_COMMENT = "comment"
CONSTRAINT_TYPE_DATATYPE = "datatype"
...
class Constraint:
    ...
    # 1.可直接使用的约束
    # 主键
    primary_key = _Constraint(value="PRIMARY KEY",
                              type=CONSTRAINT_TYPE_PRIMARY_KEY)
    # 自增主键
    auto_primary_key = _Constraint(value="PRIMARY KEY",
                                   type=CONSTRAINT_TYPE_AUTO_PRIMARY_KEY)
    # 非空约束
    not_null = _Constraint(value="NOT NULL",
                           type=CONSTRAINT_TYPE_NOT_NULL)
    # 唯一性约束
    unique = _Constraint(value="UNIQUE",
    ...
    # 非sql的特殊约束
    # 用于建表时忽略某字段/属性
    ignore = _Constraint(type=CONSTRAINT_TYPE_IGNORE)
    ...
    def default(default_value: Union[int, str, float, bytes, bool, type(None)], /):
        ...
        """
        return _Constraint(value=f'DEFAULT {default_value}',
                           type=CONSTRAINT_TYPE_DEFAULT)
    ...
    def check(check_condition: str):
        ...
        """
        return _Constraint(value=f'CHECK({check_condition})',
    ...
    def foreign_key(parent_entity, parent_field, delete_link=None, update_link=None):
        ...
        return _Constraint(value=foreign_key,
    ...
    def comment(comment: str, /):
        ...
        """
        return _Constraint(value=comment,
                           type=CONSTRAINT_TYPE_COMMENT)

    @staticmethod
    def datatype(data_type: str, /):
        return _Constraint(value=data_type,
                           type=CONSTRAINT_TYPE_DATATYPE)


# ====================================================================================================================
# 模块方法
def _parse_constraints(attr_value) -> list[_Constraint]:
    """从属性原始值中解析出约束条件。"""
    # 无约束
    constraints = []
    # 是单约束
    if isinstance(attr_value, _Constraint):
        constraints = [copy.copy(attr_value)]
    # 包含多约束
        ...
        for item in attr_value:
            ...
            if item not in constraints:
                constraints.append(copy.copy(item))
